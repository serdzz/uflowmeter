...
pub const FONT: &[(char, [u8; 8])] = &[
    ...
    // в — full-width β/В-style: three bars + two side strokes,
    //      using all 5 columns. Bowl rims align perfectly with
    //      the sides, no hanging col-4 pixels.
    //  #####
    //  #...#
    //  #####
    //  #...#
    ...
    // д — fully symmetric mini-Д: centred arched top, equal sides,
    //      baseline bar, legs aligned with the sides.
    //  .....
    //  .###.
    //  #...#
    //  #...#
    ...
    //  #####
    //  #...#
    ('д', [0x00, 0x00, 0x0e, 0x11, 0x11, 0x11, 0x1f, 0x11]),
    ...
    // ц — q-shape: shorter pillars, baseline bar at row 5, tail
    //      hangs down the right edge across two rows. Reads as a
    //      proper hanging tail, not a single stray pixel.
    //  #...#
    //  #...#
    //  #...#
    //  #####
    //  ....#
    //  ....#
    ('ц', [0x00, 0x00, 0x11, 0x11, 0x11, 0x1f, 0x01, 0x01]),
    // ч — closed top cup with two vertical sides + clean right
    //      descender. Symmetric two-pillar header, full-width
    //      baseline bar, then the right side falls to the baseline.
    //  #...#
    //  #...#
    //  #####
    //  ....#
    //  ....#
    ('ч', [0x00, 0x00, 0x11, 0x11, 0x1f, 0x01, 0x01, 0x00]),
