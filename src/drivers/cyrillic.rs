...
pub const FONT: &[(char, [u8; 8])] = &[
    ...
    // в — symmetric stacked B-bowls with consistent 4-px width.
    ('в', [0x00, 0x00, 0x1e, 0x12, 0x1e, 0x12, 0x1e, 0x00]),
    ('г', [0x00, 0x00, 0x1e, 0x10, 0x10, 0x10, 0x10, 0x00]),
    // д — mini-Д: top arc, sides, baseline bar, hanging legs.
    ('д', [0x00, 0x00, 0x0f, 0x09, 0x09, 0x09, 0x1f, 0x11]),
    ...
    // ц — descender tail thickened to 2 px so it reads as a tail, not noise.
    ('ц', [0x00, 0x00, 0x11, 0x11, 0x11, 0x11, 0x1f, 0x03]),
    // ч — pillar starts a row higher + cross-bar spans full width.
    ('ч', [0x00, 0x11, 0x11, 0x11, 0x1f, 0x01, 0x01, 0x01]),
