    ...
    fn convert_char(&mut self, c: char) -> u8 {
        match c {
            ...
            'Ш' => self
                ...
                .unwrap_or(b'W'),
            'Щ' => self
                .load_custom_char([0x15, 0x15, 0x15, 0x15, 0x15, 0x15, 0x1f, 0x01])
                .unwrap_or(b'W'),
            'Ъ' => self
                .load_custom_char([0x18, 0x08, 0x08, 0x0f, 0x09, 0x09, 0x0f, 0x00])
                .unwrap_or(b'b'),
            'Ы' => self
                .load_custom_char([0x11, 0x11, 0x11, 0x19, 0x15, 0x15, 0x19, 0x00])
                .unwrap_or(b'B'),
            'Ь' => self
            ...
            'ъ' => self
                ...
                .unwrap_or(b'b'),
            'ы' => self
                .load_custom_char([0x00, 0x00, 0x11, 0x11, 0x19, 0x15, 0x19, 0x00])
                .unwrap_or(b'b'),
            'ь' => self
